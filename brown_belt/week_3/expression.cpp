...
class SumExpression : public BinaryExpr {
public:
...
class ProductExpression : public BinaryExpr {
public:
    using BinaryExpr::BinaryExpr;
private:
    char GetSymbol() const override {
    ...
    ExpressionPtr left_part_;
    ExpressionPtr right_part_;
};
...
ExpressionPtr Sum(ExpressionPtr left, ExpressionPtr right) {
    return std::make_unique<SumExpression>(move(left), move(right));
}
ExpressionPtr Product(ExpressionPtr left, ExpressionPtr right) {
    return std::make_unique<ProductExpression>(move(left), move(right));
}
